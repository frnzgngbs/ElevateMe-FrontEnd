...
const RootProblemHistoryPopup = ({ open, onClose, problemStatement, whyStatements }) => {
  return (
    <Dialog
      open={open}
      onClose={onClose}
    ...
    >
      <DialogTitle>
        <Box display="flex" justifyContent="center" alignItems="center" position="relative">
          <Typography variant="h5" sx={{ fontWeight: "bold", color: "#00695C" }}>
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={12} md={8}>
            ...
            >
              <Typography
                variant="h6"
                sx={{ fontWeight: "bold", color: "#00695C", maxWidth:"250px",  lineHeight: 1.3, }}
              >
