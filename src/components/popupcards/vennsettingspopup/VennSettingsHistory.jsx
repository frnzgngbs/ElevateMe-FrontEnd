...
const VennSettingsHistoryPopup = ({ open, onClose }) => {
      ...
      <DialogContent>
        <Grid container spacing={2}>
          ...
          <Grid item xs={12} md={6}>
            ...
            <Box sx={{ display: "flex", justifyContent: "center", mt: 2, marginLeft:4}}>
            <Button onClick={onClose}
                type="submit"
                variant="contained"
                sx={{ py: 1, px: 4.3, borderRadius: 5, marginRight:2, color:"#186F65", backgroundColor:"#BAD4D1"}}
              >
                close
              </Button>
              <Button
