...
const VennDiagramPaper = () => {
  return (
    <MuiPaper elevation={3} sx={{ borderRadius: 5, p: 3, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", height: "100%" }}>
      <Typography variant="h4" sx={{ marginTop: "-8px", marginBottom: "80px", marginLeft:"-140px" }}>Venn Diagram</Typography>
      <Box sx={{ position: "relative", marginBottom: "20px" , marginBottom:"50px"}}>
